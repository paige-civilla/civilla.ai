  ...
  return (
        ...
        <div className="flex items-center justify-between gap-4 w-full max-w-container">
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <button 
              ...
              className="ml-2 p-1.5 rounded-md bg-gradient-to-r from-[#1F5A3A] to-[#4E9A5B] hover:from-[#1B5134] hover:to-[#438C53] text-white shadow-sm transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:ring-offset-1"
    ...
    {isMenuOpen && mainMenuPos && (
      <div 
        ...
        className="fixed w-[min(900px,calc(100vw-24px))] bg-popover border border-popover-border rounded-2xl shadow-xl p-6 md:p-8 mobile-dropdown-panel z-[9999]" 
        onMouseEnter={handleMenuMouseEnter}
        onMouseLeave={handleMenuMouseLeave}
