        ...
        <div className="flex items-center justify-between gap-3 md:gap-4 w-full max-w-container">
          ...
          <div className="flex items-center justify-center gap-1.5 md:gap-2">
            ...
            <button 
              ...
              className="ml-1.5 md:ml-2 p-1 md:p-1.5 lg:p-2 rounded-md bg-gradient-to-r from-[#1F5A3A] to-[#4E9A5B] hover:from-[#1B5134] hover:to-[#438C53] text-white shadow-sm transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:ring-offset-1"
