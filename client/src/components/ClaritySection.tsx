  ...
  return (
    <section className="w-full">
      <div className="mx-auto w-full max-w-6xl px-6 py-16 md:py-20">
        ...
        <p style={{ marginTop: 16, fontSize: 12, lineHeight: 1.5, opacity: 0.85 }}><em>*[Civilla helps you understand how cases typically move through family court through education, research, and organization—guided by your direction. Civilla doesn't provide legal advice or represent you in court.]</em></p>
</section>
  );
}
