...
export const userProfiles = pgTable("user_profiles", {
  ...
  addOnSecondCase: boolean("add_on_second_case").notNull().default(false),
  addOnArchiveMode: boolean("add_on_archive_mode").notNull().default(false),
  usageBytesMonth: bigint("usage_bytes_month", { mode: "number" }).notNull().default(0),
...
export const activityLogTypes = [
  ...
  "claim_locked",
  "claim_unlocked",
  "citations_auto_attached",
  "document_compiled",
  "document_compiled_template",
  "document_compiled_claims",
  "document_exported",
  "trial_prep_export",
  "pattern_exported",
  "binder_exported",
  ...
  "extraction_failed",
  "issue_created",
  "claim_added_to_issue",
  "memory_rebuild",
  "lexi_chat",
  "lexi_thread_created",
  "lexi_message_sent",
  "lexi_response_received",
  "module_view",
