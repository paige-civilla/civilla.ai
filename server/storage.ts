...
export class DatabaseStorage implements IStorage {
  ...
  async deleteCase(caseId: string, userId: string): Promise<boolean> {
    ...
    const deletes: ReturnType<typeof sql>[] = [
      ...
      sql`DELETE FROM draft_outlines WHERE case_id = ${caseId}`,
      sql`DELETE FROM generated_exhibit_packets WHERE case_id = ${caseId}`,
      sql`DELETE FROM exhibit_packet_items WHERE packet_id IN (SELECT id FROM exhibit_packets WHERE case_id = ${caseId})`,
      sql`DELETE FROM exhibit_packet_evidence WHERE packet_id IN (SELECT id FROM exhibit_packets WHERE case_id = ${caseId})`,
      sql`DELETE FROM exhibit_packets WHERE case_id = ${caseId}`,
      sql`DELETE FROM exhibit_snippets WHERE exhibit_id IN (SELECT id FROM exhibits WHERE case_id = ${caseId})`,
      sql`DELETE FROM exhibit_evidence WHERE exhibit_id IN (SELECT id FROM exhibits WHERE case_id = ${caseId})`,
      sql`DELETE FROM exhibits WHERE case_id = ${caseId}`,
      sql`DELETE FROM exhibit_lists WHERE case_id = ${caseId}`,
      sql`DELETE FROM resource_field_maps WHERE resource_id IN (SELECT id FROM case_resources WHERE case_id = ${caseId})`,
      sql`DELETE FROM case_resources WHERE case_id = ${caseId}`,
      sql`DELETE FROM fact_citations WHERE fact_id IN (SELECT id FROM case_facts WHERE case_id = ${caseId})`,
      sql`DELETE FROM case_facts WHERE case_id = ${caseId}`,
      sql`DELETE FROM issue_grouping_claims WHERE issue_id IN (SELECT id FROM issue_groupings WHERE case_id = ${caseId})`,
      sql`DELETE FROM issue_groupings WHERE case_id = ${caseId}`,
      sql`DELETE FROM claim_links WHERE case_id = ${caseId}`,
      sql`DELETE FROM claim_suggestion_runs WHERE case_id = ${caseId}`,
      sql`DELETE FROM citation_pointers WHERE claim_id IN (SELECT id FROM case_claims WHERE case_id = ${caseId})`,
      sql`DELETE FROM case_claims WHERE case_id = ${caseId}`,
      sql`DELETE FROM evidence_facts WHERE case_id = ${caseId}`,
      sql`DELETE FROM evidence_anchors WHERE case_id = ${caseId}`,
      sql`DELETE FROM case_exhibit_note_links WHERE case_id = ${caseId}`,
      sql`DELETE FROM case_evidence_notes WHERE file_id IN (SELECT id FROM evidence_files WHERE case_id = ${caseId})`,
      sql`DELETE FROM evidence_ocr_pages WHERE file_id IN (SELECT id FROM evidence_files WHERE case_id = ${caseId})`,
      sql`DELETE FROM evidence_extractions WHERE file_id IN (SELECT id FROM evidence_files WHERE case_id = ${caseId})`,
      sql`DELETE FROM evidence_ai_analyses WHERE file_id IN (SELECT id FROM evidence_files WHERE case_id = ${caseId})`,
      sql`DELETE FROM evidence_notes WHERE file_id IN (SELECT id FROM evidence_files WHERE case_id = ${caseId})`,
      sql`DELETE FROM evidence_processing_jobs WHERE case_id = ${caseId}`,
      sql`DELETE FROM evidence_files WHERE case_id = ${caseId}`,
      sql`DELETE FROM timeline_event_links WHERE event_id IN (SELECT id FROM timeline_events WHERE case_id = ${caseId})`,
      sql`DELETE FROM timeline_events WHERE case_id = ${caseId}`,
      sql`DELETE FROM timeline_categories WHERE case_id = ${caseId}`,
      sql`DELETE FROM generated_documents WHERE case_id = ${caseId}`,
      sql`DELETE FROM parenting_plan_provisions WHERE parenting_plan_id IN (SELECT id FROM parenting_plans WHERE case_id = ${caseId})`,
      sql`DELETE FROM parenting_plans WHERE case_id = ${caseId}`,
      sql`DELETE FROM case_children WHERE case_id = ${caseId}`,
      sql`DELETE FROM case_contacts WHERE case_id = ${caseId}`,
      sql`DELETE FROM case_communications WHERE case_id = ${caseId}`,
      sql`DELETE FROM case_calendar_items WHERE case_id = ${caseId}`,
      sql`DELETE FROM calendar_categories WHERE case_id = ${caseId}`,
      sql`DELETE FROM deadlines WHERE case_id = ${caseId}`,
      sql`DELETE FROM tasks WHERE case_id = ${caseId}`,
      sql`DELETE FROM documents WHERE case_id = ${caseId}`,
      sql`DELETE FROM case_rule_terms WHERE case_id = ${caseId}`,
      sql`DELETE FROM collaborator_roles WHERE case_id = ${caseId}`,
      sql`DELETE FROM case_invites WHERE case_id = ${caseId}`,
      sql`DELETE FROM case_collaborators WHERE case_id = ${caseId}`,
      sql`DELETE FROM lexi_case_memory WHERE case_id = ${caseId}`,
      sql`DELETE FROM processing_credit_ledger WHERE case_id = ${caseId}`,
      sql`DELETE FROM usage_events WHERE case_id = ${caseId}`,
      sql`DELETE FROM activity_logs WHERE case_id = ${caseId}`,
    ];
    ...
    await db.execute(sql`DELETE FROM cases WHERE id = ${caseId} AND user_id = ${userId}`);
    return true;
  }
